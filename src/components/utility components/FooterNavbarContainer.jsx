...
const  FooterNavbarContainer = ({ footerCopyRightText }) => {
  return (
    <div className="footer flex flex-col items-center md:flex-row justify-between py-5 px-5 my-5 border-t-2 border-gray-100 dark:border-t-[1px] dark:border-gray-800">
